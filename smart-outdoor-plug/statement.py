...
from tdsaf.main import Builder, TLS, DNS, UDP, ARP, EAPOL, ICMP, TCP, DHCP
...
tuya_4 = system.backend("Tuya Smart 4").serve(TLS(auth=True)).dns("m2.tuyaeu.com") # 3.66.126.37
...
smart_plug >> tuya_4 / TLS(auth=True)
...
mobile_app >> tuya_2 / TLS(auth=True)
